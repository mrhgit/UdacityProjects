...
public:
  ...
  /// Total number of measurements since reset
  int num_meas_;
  int num_above_NIS95_; // total number of true values outside of 95% prediction level
   ...
   */
  void UpdateLidar(MatrixXd *Zsig, VectorXd *z_pred, MatrixXd *S_pred, VectorXd *z_true, VectorXd* x_pred, MatrixXd* P_pred);

  /**
   * Updates the state and the state covariance matrix using a radar measurement
   * @param meas_package The measurement at k+1
   */
  void UpdateRadar(MatrixXd *Zsig, VectorXd *z_pred, MatrixXd *S_pred, VectorXd *z_true, VectorXd* x_pred, MatrixXd* P_pred);
};
