 ...
 Match #   Opponent    AB_Improved   AB_Custom   AB_Custom_2  AB_Custom_3 
    ...
    4     MM_Improved    7  |   3     4  |   6     6  |   4     7  |   3  
    5       AB_Open      3  |   7     6  |   4     4  |   6     4  |   6  
    6      AB_Center     5  |   5     7  |   3     4  |   6     6  |   4  
    7     AB_Improved    4  |   6     5  |   5     4  |   6     8  |   2  
--------------------------------------------------------------------------
           Win Rate:      60.0%        64.3%        51.4%        62.9%    
...
def custom_score(game, player):
    ...
    return float(distance_to_opponent/4.0 + (own_moves-opp_moves))
...
def custom_score_2(game, player):
    ...
    #distance_to_opponent = (abs(y2 - y1) + abs(x2 - x1))
    return float(distance_to_center1 - distance_to_center2)
...
def custom_score_3(game, player):
    ...
    opp_moves = len(game.get_legal_moves(game.get_opponent(player)))
    #distance_to_opponent = (abs(y2 - y1) + abs(x2 - x1))
    return float((distance_to_center2 - distance_to_center1)*(own_moves))
