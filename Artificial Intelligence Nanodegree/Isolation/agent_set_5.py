 ...
 Match #   Opponent    AB_Improved   AB_Custom   AB_Custom_2  AB_Custom_3 
    ...
    2       MM_Open      7  |   3     6  |   4     5  |   5     6  |   4  
    3      MM_Center     9  |   1     7  |   3     9  |   1     8  |   2  
    4     MM_Improved    6  |   4     6  |   4     4  |   6     6  |   4  
    5       AB_Open      5  |   5     5  |   5     4  |   6     7  |   3  
    6      AB_Center     4  |   6     7  |   3     5  |   5     4  |   6  
    7     AB_Improved    4  |   6     6  |   4     6  |   4     6  |   4  
--------------------------------------------------------------------------
           Win Rate:      60.0%        65.7%        60.0%        67.1%    
...
def custom_score(game, player):
    ...
    return float(distance_to_opponent + 4*(own_moves-opp_moves))
...
def custom_score_2(game, player):
    ...
    y2, x2 = game.get_player_location(game.get_opponent(player))
    distance_to_opponent = (abs(y2 - y1) + abs(x2 - x1))
    return float(-1*distance_to_opponent)
