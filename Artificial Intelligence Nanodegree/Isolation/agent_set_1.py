 ...
 Match #   Opponent    AB_Improved   AB_Custom   AB_Custom_2  AB_Custom_3 
    ...
    2       MM_Open      5  |   5     6  |   4     5  |   5     7  |   3  
    3      MM_Center     7  |   3     8  |   2     7  |   3     7  |   3  
    4     MM_Improved    5  |   5     5  |   5     5  |   5     6  |   4  
    5       AB_Open      4  |   6     5  |   5     5  |   5     4  |   6  
    6      AB_Center     4  |   6     8  |   2     6  |   4     7  |   3  
    7     AB_Improved    4  |   6     4  |   6     4  |   6     7  |   3  
--------------------------------------------------------------------------
           Win Rate:      54.3%        64.3%        60.0%        65.7%    
...
def custom_score(game, player):
    ...
    #distance_to_center = ((h - y)**2 + (w - x)**2)
    p1 = 0.0# *  own_moves
    p2 = 0.0# *  (min([w,h])*blank_spaces/(w*h) - move_count)
    p3 = 1.0 *  (own_moves-opp_moves)*1.0/(blank_spaces/(w*h))
    p4 = 0.0# *  distance_to_center
    return p1+p2+p3+p4
...
def custom_score_2(game, player):
    ...
    p1 = 0.0# *  own_moves
    p2 = 0.0# *  (min([w,h])*blank_spaces/(w*h) - move_count)
    p3 = 1.0 *  (own_moves-opp_moves)*move_count
    p4 = 0.0# *  distance_to_center
    return p1+p2+p3+p4
...
def custom_score_3(game, player):
    ...
    y, x = game.get_player_location(player)
    distance_to_center = ((h - y)**2 + (w - x)**2)
    average_distance_to_center = (w/2)**2 + (h/2)**2
    p1 = 0.0# *  own_moves
    p2 = 0.0# *  (min([w,h])*blank_spaces/(w*h) - move_count)
    p3 = 0.5 *  (own_moves-opp_moves)*1.0/(blank_spaces/(w*h))
    p4 = 0.5 *  distance_to_center - average_distance_to_center
    return p1+p2+p3+p4
