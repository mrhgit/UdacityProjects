 ...
 Match #   Opponent    AB_Improved   AB_Custom   AB_Custom_2  AB_Custom_3 
    ...
    1       Random      182 |  18    188 |  12    188 |  12    180 |  20  
    2       MM_Open     103 |  97    121 |  79    128 |  72    122 |  78  
    3      MM_Center    168 |  32    172 |  28    167 |  33    167 |  33  
    4     MM_Improved   100 |  100   118 |  82    109 |  91    114 |  86  
    5       AB_Open     91  |  109   106 |  94    121 |  79    102 |  98  
    6      AB_Center    116 |  84    123 |  77    123 |  77    117 |  83  
    7     AB_Improved   91  |  109   113 |  87    111 |  89    116 |  84  
--------------------------------------------------------------------------
           Win Rate:      60.8%        67.2%        67.6%        65.6%    
...
def custom_score(game, player):
    ...
    """
    #optimistic about remaining moves
...
def custom_score_3(game, player):
    ...
    #pessimistic about remaining moves
    opponent = game.get_opponent(player)
    own_moves = len(game.get_legal_moves(player))
    opp_moves = len(game.get_legal_moves(opponent))
    if (player == game._inactive_player): # we're waiting for opp to move
